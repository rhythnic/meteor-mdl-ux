/**
 * This is the original script from Material Design Lite v1.0.4.
 * The script has been modified to expose the 'componentHandler' variable to the package's global scope.
 */
 ...
 * NOTICE
 * ;(function() {"use strict";
 * removed from to make componentHandler accessible to other files in the mdl-ux package
 */
...
/**
 * NOTICE
 * 'window.' removed from componentHandler to make it accessible to other files in the mdl-ux package
 */
